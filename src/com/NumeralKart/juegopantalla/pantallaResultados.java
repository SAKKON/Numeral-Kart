...
public class pantallaResultados extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jTextArea2.setText(
				"RESULTADOS DEL JUGADOR\t\t\tRESULTADOS DEL CPU: \n\nEJERCICIOS:\t\t\t\tEJERCICIOS:\n\nBANDERAS OPTENIDAS \t\t\tBANDERAS OBTENIDAS: \n\nERRORES COMTIDOS\n\nTIEMPO DE JUEGO:");
						...
						.addGroup(layout.createSequentialGroup().addContainerGap()
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										.addComponent(jScrollPane1).addComponent(jScrollPane2,
												javax.swing.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)))
						.addGroup(layout.createSequentialGroup().addGap(176, 176, 176).addComponent(jButton1,
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(pantallaResultados.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
